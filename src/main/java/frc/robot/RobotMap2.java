...

{
    ...
    public static final int joystickPort = 1; //PWM Port 1
    public static final int intakeLeftPort = 2;  //PWM Port 2
    public static final int intakeRightPort = 3;
    ...
    public static final int right2Port = 15;
}